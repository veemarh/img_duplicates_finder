...
def create_actions(main_window):
    ...
    main_window.addFolderAction = QAction(QIcon("static/add.png"), "&Add", main_window)
    ...
    main_window.removeSelAction = QAction(QIcon("static/remove.png"), "&Remove", main_window)
    ...
    main_window.clearFoldersAction = QAction("&Clear", main_window)
